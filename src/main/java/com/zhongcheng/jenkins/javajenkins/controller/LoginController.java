...
import com.zhongcheng.jenkins.javajenkins.model.dto.req.LoginDto;
...
public class LoginController {
    ...
    public CommonResult<User> login(@RequestBody @Validated LoginDto dto, HttpServletRequest request) {
        User user = loginServer.login(dto.getUser(), dto.getPwd());
